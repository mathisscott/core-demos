...
import { ClarityIcons, cloudScaleIcon, factoryIcon, networkSettingsIcon, nodeGroupIcon, nodeIcon, nodesIcon, plusIcon, refreshIcon, gridViewIcon, viewListIcon, wrenchIcon, twoWayArrowsIcon, checkIcon, warningStandardIcon, cogIcon, angleIcon } from '@clr/core/icon-shapes';
...
ClarityIcons.addIcons(['clarity-logo', clarityLogo], cloudScaleIcon, factoryIcon, networkSettingsIcon, nodeIcon, nodesIcon, nodeGroupIcon, plusIcon, wrenchIcon, gridViewIcon, viewListIcon, refreshIcon, twoWayArrowsIcon, checkIcon, warningStandardIcon, cogIcon, angleIcon);